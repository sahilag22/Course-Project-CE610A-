% Model-3a : Discretized daily water balance model for '2010' daily data
...
for st_1 = 40:50
    for tc = 30:40
        for sb = 180:200
            outflow = fmodel_3a(p10, ep10, sb, st_1, tc);   % obtained modelled monthly outflow values for 'sb' storage 
...
outflow = fmodel_3a(p10, ep10, S_b, St_1, T_c);             % modelled outflow
