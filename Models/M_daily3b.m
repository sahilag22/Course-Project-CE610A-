...
% Considering overflow and adding it to outflow
...
for st_1 = 90:100
    for tc = 70:80
        for sb = 900:1000
            outflow = fmodel_3b(p10, ep10, sb, st_1, tc);   % obtained modelled monthly outflow values for 'sb' storage 
...
outflow = fmodel_3b(p10, ep10, S_b, St_1, T_c);         % modelled outflow
